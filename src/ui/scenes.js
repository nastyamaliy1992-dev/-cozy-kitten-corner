...
export function renderRoomDecor(room,ui={}){
 ...
 if(room==='playroom')return `<div class="decor playroom-decor real-room">${background}<button class="scene-hotspot playroom-toy-hotspot" data-object="toy" aria-label="Игрушки"></button></div>`;

...
export function renderPet({sleeping=false,emotion='calm',activity='idle'}={}){
  ...
  const assetState = sleeping ? 'sleep' : activity==='eating' ? 'eat' : activity==='petted' ? 'pet' : emotion==='tired' ? 'sleepy' : emotion==='hungry' ? 'hungry' : emotion==='sad' ? 'sad' : emotion==='joyful' ? 'happy' : 'idle';
  const pose = sleeping ? 'sleep' : activity==='eating' ? 'eat' : activity==='petted' ? 'pet' : activity==='play' ? 'play' : emotion==='joyful' ? 'happy' : 'idle';
